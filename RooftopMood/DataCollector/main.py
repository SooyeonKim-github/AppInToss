...
def parse_args() -> argparse.Namespace:
    ...
    sub.add_parser("classify", help="Kakao Local + 블로그 Evidence 기반 Rooftop/View 분류")
    ...
    all_parser.add_argument("--limit", type=int, default=None, help="Evidence 수집만 처음 N개 후보로 제한")
